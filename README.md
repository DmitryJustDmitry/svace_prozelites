...
3. В исходный код теста *желательно (это рекомендация, а не требование)* не закладывать каких-либо ошибок, выявляемых svace, за исключением той конкретной ошибки, которую вы закладываете в данный тест. 
